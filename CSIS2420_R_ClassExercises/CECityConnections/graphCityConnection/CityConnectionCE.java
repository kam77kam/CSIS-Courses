...
public class CityConnectionCE {
	...
	public static void main(String[] args) {
		...
		for(Edge edge : mst.edges()) {
			StdOut.println(sg.nameOf(edge.either()) + " to " + sg.nameOf(edge.other(edge.either())) + " (" + edge.weight() + ")"); //for each edge print the names of the vertices and the weight in parenthesis
		}
		StdOut.println();

...
public class MainPageJFrame extends JFrame implements KeyListener, ActionListener, MouseListener {
	...
	public final static String filesToPath = "A08_FinalGroupProject/movieConnect/Resources/Files/";
	...
	private void addButtons() {
		...
		dislikeButton.setIcon(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/dislike.png"));
		...
		likeButton.setIcon(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/like.png"));
	...
	private void generateRandomMovie() {
		...
		String imagePath = "A08_FinalGroupProject/movieConnect/Resources/Images/" + randomMovie + ".jpg";
	...
	private void initImage() {
		...
		JLabel background = new JLabel(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/background5.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == reFresh) {
			...
			JDialog jDialog = new JDialog();
			JLabel jLabel = new JLabel(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/about.png"));
	...
	public void mousePressed(MouseEvent e) {
		if (e.getSource() == dislikeButton) {
			dislikeButton.setIcon(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/dislikepress.png"));
		} else if (e.getSource() == likeButton) {
			likeButton.setIcon(new ImageIcon("A08_FinalGroupProject/movieConnect/Resources/Images/likepress.png"));
		}

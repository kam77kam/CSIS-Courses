...
public class DemoWrapperClassGui extends JFrame {
    ...
    private JRadioButton btnConvertToStuff;
    ...
    private void createNumberControlPanel() {
        ...
        DemoWrapperClass dmc = new DemoWrapperClass();
        btnConvertToStuff = new JRadioButton("Binary Oct Hex");
        btnConvertToStuff.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		numberTextArea.setText(dmc.toBinary(15));
        	}
        });
        buttonGroup_1.add(btnConvertToStuff);
        numberControlPanel.add(btnConvertToStuff);
    }
...
//      charTextArea.setHorizontalAlignment(SwingConstants.CENTER);
    ...
    private void createCharControlPanel() {
        ...
        btnCharSubmit = new JTextField("k");
        btnCharSubmit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                charTextArea.setText(dwc.charProperties(btnCharSubmit.getText().charAt(0)));
            }
        });
        btnCharSubmit.setColumns(10);
